...
const directions = ({forward ,backward , left , right}:{forward:boolean , backward:boolean,left:boolean,right:boolean}) =>{
...
let directionsz = directions({
    ...
    //rotate model 
    rotateQuaternaion.setFromAxisAngle(rotateAngle , angleYCameraDirection + directionsz)
